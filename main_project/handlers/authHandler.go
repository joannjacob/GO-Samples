...
var CreateAccount = func(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		u.Respond(w, u.Message(400, "Invalid request"), 400)
...
var Refresh = func(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if err == http.ErrNoCookie {
			u.Respond(w, u.Message(401, "No cookie found"), 401)
	...
	if err != nil {
		if err == jwt.ErrSignatureInvalid {
			u.Respond(w, u.Message(401, "Signature Invalid"), 401)
	...
	if !tkn.Valid {
		u.Respond(w, u.Message(401, "Unauthorized"), 401)
	...
	if time.Unix(claims.ExpiresAt, 0).Sub(time.Now()) > 30*time.Second {
		u.Respond(w, u.Message(400, "Current token has more time left to expire"), 400)
	...
	resp := u.Message(200, "New token generated")
	u.Respond(w, resp, 200)
}
